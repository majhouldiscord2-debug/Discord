  ...
  return (
    <div className="flex-1 h-full flex flex-col min-w-0 overflow-hidden" style={{ backgroundColor: "#080000" }}>
      ...
      <div className="flex-1 overflow-y-auto discord-scrollbar px-4 py-4 space-y-5">
        {user && (
          <div className="rounded-[16px] overflow-hidden" style={{ background: "linear-gradient(135deg, #2a0000 0%, #150000 50%, #080000 100%)", border: "1px solid rgba(200,0,0,0.25)", boxShadow: "0 8px 40px rgba(180,0,0,0.12)" }}>
            <div className="h-[70px] w-full relative" style={{ background: "linear-gradient(135deg, #cc0000 0%, #8b0000 50%, #3d0000 100%)" }}>
            ...
            <div className="px-5 pb-4 -mt-7 flex items-end gap-4">
              <div className="relative shrink-0">
                ...
                <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full bg-[#23a55a] ring-2 ring-[#080000]" />
              </div>
              ...
              {stats.isBot && (
                <div className="ml-auto mb-1 shrink-0 flex items-center gap-1.5 px-2.5 py-1 rounded-[6px] text-[11px] font-bold" style={{ background: "#cc000022", color: "#ff6060", border: "1px solid #cc000040" }}>
