...
export default function Stats() {
  ...
  return (
    <div className="flex-1 h-full flex flex-col min-w-0 overflow-hidden" style={{ backgroundColor: "#000" }}>
      <div className="h-12 shrink-0 flex items-center px-5 gap-2" style={{ borderBottom: "1px solid rgba(204,0,0,0.18)", background: "linear-gradient(180deg, #0d0000 0%, #000 100%)" }}>
