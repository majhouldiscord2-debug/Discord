...
const QUESTS: QuestItem[] = [
  { id: 1, game: "Pokémon GO", developer: "Niantic", questTitle: "POKÉMON GO QUEST", reward: 200, description: "Watch the video to win 200 Orbs!", endsDate: "3/21", banner: <PokeBanner />, accentColor: "#ffa53e" },
  { id: 2, game: "EVE Frontier", developer: "CCP Games", questTitle: "EVE FRONTIER VIDEO QUEST", reward: 200, description: "Watch the video to win 200 Orbs!", endsDate: "3/21", banner: <EveBanner />, accentColor: "#ff6b6b" },
  { id: 3, game: "Arknights: Endfield", developer: "Gryphline", questTitle: "VERSION UPDATE: TANGTANG", reward: 700, description: "Play Arknights: Endfield for 15 minutes to win 700 Orbs.", endsDate: "3/23", banner: <ArkBanner />, accentColor: "#66aaff" },
  { id: 4, game: "Valheim", developer: "Iron Gate", questTitle: "VALHEIM ASHLANDS QUEST", reward: 500, description: "Play Valheim for 30 minutes to earn 500 Orbs!", endsDate: "3/25", banner: <ValBanner />, accentColor: "#7dde86" },
];

const SUGGEST_OPTIONS = ["Suggested", "New", "Ending Soon", "High Reward"];
    ...
    <div className="rounded-xl overflow-hidden transition-all duration-200 cursor-pointer"
      ...
      <div className="px-3 pt-3 pb-1">
        <div className="flex items-center gap-1 mb-1">
          ...
          <div className="flex-1" />
          <span className="text-[10px] text-[#949ba4]">Ends {quest.endsDate}</span>
        </div>
